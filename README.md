...
Windows 开发与测试请先阅读 **[Windows 界面入口、功能与完整测试指南](WINDOWS_TESTING_GUIDE.md)**，包含浏览器预览、桌面启动、PostgreSQL 配置、双人测试、现有功能、验收表和打包步骤。当前代码已使用 Tauri 2；下方及旧测试指南中的部分启动说明已过时，以新指南为准。
