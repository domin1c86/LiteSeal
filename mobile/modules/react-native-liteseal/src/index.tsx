...
import installer from './NativeLiteseal';
...
export * from './generated/liteseal_core';

// Now import the bindings so we can:
// - intialize them
// - export them as namespaced objects as the default export.
import * as liteseal_core from './generated/liteseal_core';
...
if (!initialized) {
  liteseal_core.default.initialize();
  initialized = true;
}
