...
@ReactModule(name = LitesealModule.NAME)
class LitesealModule(reactContext: ReactApplicationContext) :
  NativeLitesealSpec(reactContext) {
  ...
  companion object {
    const val NAME = "Liteseal"

    init {
      System.loadLibrary("react-native-liteseal")
    }
  }
}